...
<body>
	<div class="container mt-5">
		...
		<form action="mua-hang" method="get">
			Số lương cần mua: <input class="form-control" type="text"
				name="soLuong" /> <span class="rq"><%=e_soLuong%></span><br /> Số
			điện thoại: <input class="form-control" type="text"
				name="soDienThoai" /> <span class="rq"><%=e_soDienThoai%></span> <br />
			Email: <input class="form-control" type="text" name="email" /> <span
				class="rq"><%=e_email%></span><br />
